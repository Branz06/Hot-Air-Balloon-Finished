...
bgImg2 = loadImage("assets/bgImg.jpg")
...
//using API calls to set the backround image according to time
async function getBackroundImg(){
  var respone = await fetch("http//worldtimeapi.org/timezone/Asia/Kolkata");
